...
class NucleiDataset(utils.Dataset):
    ...
    def load_nuclei(self, image_ids, height, width, file_path = TRAIN_PATH_512, alternate_path1 = TRAIN_PATH_CLAHE, alternate_path2 = None):
        ...
        for i, id_ in enumerate(image_ids):
            ...
            self.add_image("nuclei", image_id=i, path=image_path,
                           ...
                           id_ = id_, height=height, width=width,)
...
dataset_train.load_nuclei(train_ids, config.IMAGE_SHAPE[0], config.IMAGE_SHAPE[1])
dataset_train.prepare()

# Validation dataset
dataset_val = NucleiDataset(augment = False)
dataset_val.load_nuclei(valid_ids, config.IMAGE_SHAPE[0], config.IMAGE_SHAPE[1])
dataset_val.prepare()
...
dataset_test.load_nuclei(test_ids, inference_config.IMAGE_SHAPE[0], inference_config.IMAGE_SHAPE[1], TEST_PATH)
...
model_path = model.find_last()[1] # '/root/briansp/git/Mask_RCNN/logs/nuclei20180322T2343/mask_rcnn_nuclei_0014.h5' # LB .491
...
submit_filename = 'sub-mask-rcnn-9-73.csv'
